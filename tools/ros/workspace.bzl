def ros_deps():
    ...
    native.new_http_archive(
        ...
        build_file = "@rules_ros//third_party/ros:ros.BUILD",
    )
    ...
    native.new_http_archive(
        ...
        build_file = "@rules_ros//third_party/ros:roscpp_core.BUILD",
    )
    ...
    native.new_http_archive(
        ...
        build_file = "@rules_ros//third_party/ros:ros_comm.BUILD",
    )
    ...
    native.new_http_archive(
        ...
        build_file = "@rules_ros//third_party/ros:genmsg.BUILD",
    )
    ...
    native.new_http_archive(
        ...
        build_file = "@rules_ros//third_party/ros:gencpp.BUILD",
    )
    ...
    native.new_http_archive(
        ...
        build_file = "@rules_ros//third_party/ros:std_msgs.BUILD",
    )
    ...
    native.new_http_archive(
        ...
        build_file = "@rules_ros//third_party/ros:ros_comm_msgs.BUILD",
    )
    ...
    native.new_http_archive(
        ...
        build_file = "@rules_ros//third_party/ros:console_bridge.BUILD",
    )
